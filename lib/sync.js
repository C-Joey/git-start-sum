...
import { getCompleteStarsData, getTags, getHistory, getSettings, setLastSync, replaceAllStarsData, saveTags } from './storage.js';
...
export async function exportToMarkdown() {
    const [starsData, tags] = await Promise.all([getCompleteStarsData(), getTags()]);
